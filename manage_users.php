...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_user'])) {
    ...
    if ($user_id_to_delete == $current_user_id) {
        ...
        try {
            // In a real-world application, you would handle related records (savings, etc.)
            // For this project, we'll assume cascading delete or manual cleanup.
            // We will delete the user. Related savings will remain for auditing but will be orphaned.
                    ...
                    <?php foreach ($users as $user): ?>
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <form action="manage_users.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this user? This action cannot be undone.');">
