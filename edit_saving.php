    ...
    <?php elseif ($saving): ?>
        <form action="process_edit_saving.php" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="text" inputmode="numeric" data-type="currency" name="new_amount" id="new_amount" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="<?php echo htmlspecialchars((int)$saving['amount']); ?>">
            </div>
