...
```bash
ddev import-db --file=db.sql && ddev ssh -s web --mysql -e "INSERT INTO users (id, account_no, username, email, password, role_id) VALUES (1, 'POA00000', 'root', 'root@poa.dev', '\$2y\$10\$wHf3GZc5AZVYGYfMqW3iDuKEw1RE3vW4koKBJXYUE.OGnsb.ROJUC', 1), (2, 'POA00001', 'chairman', 'chairman@poa.dev', '\$2y\$10\$wHf3GZc5AZVYGYfMqW3iDuKEw1RE3vW4koKBJXYUE.OGnsb.ROJUC', 2);"
```
